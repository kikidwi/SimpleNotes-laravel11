            ...
            <div class=" mt-2 border-2 border-black rounded-lg w-44 h-auto">
                ...
                @foreach ($notes as $dataNote)
                    <div  class="border-2 border-black rounded-lg p-1 max-w-50 m-1 overflow-hidden hover:bg-[#D9D9D9] flex flex-row place-content-between">
                        <div id="listNote" data-modal-target="showNote" data-modal-toggle="showNote" class="cursor-pointer w-[200px]">
                ...
                <form id="saveForm" action="{{url('insertData')}}" method="post">
                    ...
                    <div class="flex flex-row">
                        <div class="col-span-full mr-2">
                            <div class="mt-2">
                                <input id="judul" type="text" name="judulNotes"  class="border-2 border-black rounded-md w-[650px] pl-2" required>
                            </div>
                        </div>
                        <div class="mt-2">
                    ...
                    <div class="col-span-full">
                        <div class="mt-2">
                        <textarea id="isi" name="isiNotes" rows="3" class="block rounded-md border-2 border-black w-[914px] pl-2 h-auto" required></textarea>
                        </div>
                    </div>
                </form>
            </div>
